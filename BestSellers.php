    ...
    <nav class="navbar">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: transparent" >
              <li><a class="dropdown-item" href="BestSellers.php" class="active">Best Sellers</a></li>
            ...
            <div class="row" style="margin-top: 30px;">
                <?php foreach ($productChunk as $product): ?>
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            <img class="card-img" src="<?php echo $product['image']; ?>" alt="">
                            <div class="card-body">
